...
This is **extended-data-types** - part of the jbcom Python library ecosystem.

## Project Context

- **Repository**: jbcom/extended-data-types
- **PyPI Package**: extended-data-types
...
- **Automation**: python-semantic-release runs on CI merges to main
- **NEVER manually edit** `__version__` in `__init__.py`
- **NEVER suggest** alternative versioning systems or manual bumps
...
Example:
```bash
gh issue comment --repo jbcom/jbcom-control-center 123 --body "✅ Completed task in jbcom/extended-data-types. PR: #45"
```
