...
class HCL2Serializer(AbstractSerializer):
    ...
    def encode(self, obj: Any, **kwargs) -> str:
        ...
        if "indent_size" in kwargs or "sort_keys" in kwargs:
            self.hcl.generator.indent_size = kwargs.get(
                "indent_size", self.hcl.generator.indent_size
            )
            self.hcl.generator.sort_keys = kwargs.get(
                "sort_keys", self.hcl.generator.sort_keys
            )
