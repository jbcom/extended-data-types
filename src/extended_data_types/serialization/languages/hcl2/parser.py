...
class HCL2Parser:
    ...
    def _parse_block(self, ctx: ParserContext) -> Block | None:
        ...
        block = Block(type=block_type, labels=labels)
    ...
    def _parse_attribute(
        self, ctx: ParserContext, target: Union[Block, HCLFile]
    ) -> None:
    ...
    def _parse_function_args(self, args_str: str) -> list[Any]:
        ...
        return [
            self._parse_expression(arg.strip()) for arg in self._split_args(args_str)
        ]
