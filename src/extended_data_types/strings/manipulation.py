...
class StringManipulator:
    ...
    def bytes_to_str(
        self,
        value: str | memoryview | bytes | bytearray,
        ...
        if not isinstance(value, (bytes, bytearray)):
            raise TypeError(f"Expected bytes-like object, got {type(value).__name__}")
    ...
    def sanitize_key(
        ...
        sanitized = "".join(
            c if c.isalnum() or c == delimiter else delimiter for c in key_str
        )
