...
from extended_data_types.transformations.datetime.format import (
    format_date, format_datetime, format_time, format_timedelta, parse_date,
    parse_datetime, parse_time, parse_timedelta)
...
def test_parse_timedelta() -> None:
    ...
    assert parse_timedelta("1d 2h 30m") == timedelta(
