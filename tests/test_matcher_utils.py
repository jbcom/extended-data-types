...
the `extended_data_types` package. It includes parameterized tests for partial matching and non-empty matching of
strings and collections.

Functions:
    - test_is_partial_match: Tests partial matching of strings with optional prefix check.
    - test_is_non_empty_match: Tests non-empty matching of various types including strings, dictionaries, and lists.
"""
