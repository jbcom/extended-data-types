...
from extended_data_types.serialization.languages.hcl2.generator import HCL2Generator
...
def test_generate_basic_block():
    ...
    block = Block(
        ...
        attributes={"instance_type": "t2.micro", "tags": {"Name": "web-server"}},
    )
    ...
    block = Block(
        ...
        blocks=[
            Block(
                ...
                labels=[],
                attributes={
                    "network_interface_id": Reference(
                        "aws_network_interface", "web", "id"
                    ),
                    "device_index": 0,
                },
            )
