...
def test_convert_auto_format_detection(runner: CliRunner, tmp_path: Path, sample_json: Path):
...
def test_convert_with_different_indentation(runner: CliRunner, tmp_path: Path, sample_json: Path):
