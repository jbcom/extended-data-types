# Repository Guidelines for Contributors and AI Agents

This document provides comprehensive guidelines for contributing to Extended Data Types, including development workflows, release processes, and coding standards.

## Table of Contents

1. [Project Structure & Modules](#project-structure--modules)
2. [Build, Test, and Development Commands](#build-test-and-development-commands)
3. [Coding Style & Naming](#coding-style--naming)
4. [Testing Guidelines](#testing-guidelines)
5. [Commit & Pull Request Guidelines](#commit--pull-request-guidelines)
6. [Release Architecture](#release-architecture)
7. [Version Management](#version-management)
8. [Agent-Specific Notes](#agent-specific-notes)
