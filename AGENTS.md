...
**This repository uses a UNIFIED CI workflow** that combines testing, quality checks, AND release automation in a **single `ci.yml` file**. This is the REFERENCE IMPLEMENTATION for all our ecosystem repositories.
...
- ✅ Version is read from `__init__.py` via hatchling
...
```
Version Source: src/extended_data_types/__init__.py
   ↓
__version__ = "5.1.2"
   ↓
...
Used by: semantic-release for version detection
   ↓
Tag Created: v5.1.2 (or next version based on commits)
   ↓
...
**Reality:** The workflow has successfully run hundreds of times. It works as designed.
...
This repository's workflow design is the REFERENCE for:
- ✅ directed-inputs-class
- ✅ lifecyclelogging
- ✅ All future ecosystem repositories

When updating ecosystem repos, COPY this workflow design, don't modify it based on agent suggestions.

## 🤝 Getting Help

If you're an AI agent uncertain about a suggestion:
1. Check this document first
2. This repo is the authoritative source
...
**Status:** REFERENCE IMPLEMENTATION - Copy to other repos
